export default function ListItem({ comp }) {
  return (
    ...
    <article className="flex flex-col md:flex-row items-center md:items-start justify-center space-x-12 mb-4 p-6">
      <img
        src={comp.img}
        alt=""
      ...
      <div className="min-w-0 relative flex-auto mt-4 md:mt-0 border-b border-slate-200">
        ...
        <dl className="mt-2 flex flex-wrap text-sm leading-6 font-medium h-32">
